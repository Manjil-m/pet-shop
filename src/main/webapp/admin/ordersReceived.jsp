...
//        request.setAttribute("totalOrderReceived", totalOrdersReceived);
    %>
        </table>

<p>Total Orders Received: <%= totalOrdersReceived %></p>
<%--<%--%>
<%--    // Previous code to calculate totalOrdersReceived--%>

<%--    // Set totalOrdersReceived in the request--%>
<%--    request.setAttribute("totalOrdersReceived", totalOrdersReceived);--%>
