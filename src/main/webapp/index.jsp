...
<%--                <span class = "position-absolute top-0 start-100 translate-middle badge bg-primary">2</span>--%>
        ...
        <div class = "collapse navbar-collapse order-lg-1" id = "navMenu">
            <ul class = "navbar-nav mx-auto text-center">
                ...
                <li class = "nav-item px-2 py-2 border-0">
                    <a class = "nav-link text-uppercase text-dark" href = "login.jsp">Login</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class = "collection-list mt-4 row gx-0 gy-3">
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                    ...
                    <div class = "text-center">
                        ...
                        <p class = "text-capitalize my-1">Pedigree</p>
                ...
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                    <div class = "collection-img position-relative">
                        <img src = "images/carrier.jpg" class = "w-100">
                        <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                    </div>
                    <div class = "text-center">
                        <div class = "rating mt-3">
                        ...
                        <p class = "text-capitalize my-1">Carrier</p>
                        <span class = "fw-bold">Rs. 500</span>
                    </div>
                </div>
                ...
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                    ...
                    <div class = "text-center">
                        ...
                        <p class = "text-capitalize my-1">Dog Belt-Long</p>
                ...
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                    <div class = "collection-img position-relative">
                        <img src = "images/dog_belt.jpg" class = "w-100">
                        <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                    </div>
                    <div class = "text-center">
                        <div class = "rating mt-3">
                        ...
                        <p class = "text-capitalize my-1">Dog Belt</p>
                ...
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                    <div class = "collection-img position-relative">
                        <img src = "images/FoamCare-Bottles.jpg" class = "w-100">
                        <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                    </div>
                    <div class = "text-center">
                        <div class = "rating mt-3">
                        ...
                        <p class = "text-capitalize my-1">FoamCare</p>
                ...
                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                    <div class = "collection-img position-relative">
                        <img src = "images/jewelry.jpg" class = "w-100">
                        <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                    </div>
                    <div class = "text-center">
                        <div class = "rating mt-3">
                        ...
                        <p class = "text-capitalize my-1">Dog Jewelry</p>
                        <span class = "fw-bold">Rs. 1500</span>
                    </div>
                </div>

                <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                    <div class = "collection-img position-relative">
                        <img src = "images/brush.jpg" class = "w-100">
                        <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                    </div>
                    <div class = "text-center">
                        <div class = "rating mt-3">
                        ...
                        <p class = "text-capitalize my-1">Grooming Brush</p>
                        <span class = "fw-bold">Rs. 200</span>
                    </div>
                </div>
    ...
    <div class = "container">
        ...
        <div class = "special-list row g-0">
            <div class = "col-md-6 col-lg-4 col-xl-3 p-2">
                ...
                <div class = "text-center">
                    <p class = "text-capitalize mt-3 mb-1">Pedigree</p>
                    <span class = "fw-bold d-block">Rs. 500</span>
                    <a href = "addToCartAction.jsp" class = "btn btn-primary mt-3">Add to Cart</a>
                </div>
            </div>
            ...
            <div class = "col-md-6 col-lg-4 col-xl-3 p-2">
                ...
                <div class = "text-center">
                    <p class = "text-capitalize mt-3 mb-1">Dog Jewelry</p>
                    <span class = "fw-bold d-block">Rs. 1500</span>
                    <a href = "pleaseLogin.jsp" class = "btn btn-primary mt-3">Add to Cart</a>
                </div>
            </div>
            ...
            <div class = "col-md-6 col-lg-4 col-xl-3 p-2">
                ...
                <div class = "text-center">
                    <p class = "text-capitalize mt-3 mb-1">Pet Home</p>
                    <span class = "fw-bold d-block">Rs. 2500</span>
                    <a href = "pleaseLogin.jsp" class = "btn btn-primary mt-3">Add to Cart</a>
                </div>
            </div>
            ...
            <div class = "col-md-6 col-lg-4 col-xl-3 p-2">
                ...
                <div class = "text-center">
                    <p class = "text-capitalize mt-3 mb-1">Carrier</p>
                    <span class = "fw-bold d-block">Rs. 500</span>
                    <a href = "pleaseLogin.jsp" class = "btn btn-primary mt-3">Add to Cart</a>
                </div>
            </div>
    ...
    <div class = "container">
        <div class = "row text-white g-4">
            <div class = "col-md-6 col-lg-3">
                <a class = "text-uppercase text-decoration-none brand text-white" href = "index.html">PetShop</a>
            ...
            <div class = "col-md-6 col-lg-3">
                ...
                <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                    ...
                    <span class = "fw-light">
                           Bhimsensthan, Basantapur-20, Kathmandu
                        </span>
                </div>
                <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                        <span class = "me-3">
